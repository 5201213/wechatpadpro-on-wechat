...
class DifyBot(Bot):
    ...
    def reply(self, query, context: Context=None):
        ...
        if context.type == ContextType.TEXT or context.type == ContextType.IMAGE_CREATE:
            ...
            user = None
            if channel_type in ["wx", "wework", "wxpad"]:
                ...
                return Reply(ReplyType.ERROR, f"unsupported channel type: {channel_type}, now dify only support wx, wechatcom_app, wechatmp, wechatmp_service, wxpad channel")
